...
var FileUpload = function () {
    ...
    _createClass(FileUpload, [{
        key: '_binder',
        value: function _binder() {
            var _this2 = this;

            Array.prototype.forEach.call(this.inputs, function (inp) {
                return inp.addEventListener('change', _this2._addPreview.bind(_this2));
            });
        }
    }, {
        key: '_addPreview',
        value: function _addPreview(event) {
        ...
        key: '_addName',
        value: function _addName(input) {

            var label = input.nextElementSibling,
                labelVal = label.innerHTML,
                fileName = input.value.split('\\').pop();

            if (fileName) label.querySelector('strong').innerHTML = fileName;else label.innerHTML = labelVal;
        }
    }, {
        key: 'notify',
...
**/
var mySwiper = new Swiper('.select-cover', {
    loop: false,
...
**/
main.on('onSlideChangeEnd', function () {
...
**/
var unlockSwiper = function unlockSwiper() {
    main.unlockSwipes();
...
/**
  ...
  * @param {string} selector of the element
**/
var fileUpload = new FileUpload('upload-input');
...
var covers = doc.querySelectorAll('[type="radio"]');

/**
  * @desc get the submit button
**/
var submit = doc.querySelector('.to-submit');
