!function (e, t) {
  "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("Tuto", [], t) : "object" == typeof exports ? exports.Tuto = t() : e.Tuto = t();
}(this, function () {
  return function (e) {
    function t(s) {
    ...
    function s(e, t) {
      ...
      function e(t) {
        var i = this;s(this, e), this.config = this.mergeSettings(t), this.selector = "string" == typeof this.config.selector ? document.querySelector(this.config.selector) : this.config.selector, this.selectorWidth = this.selector.getBoundingClientRect().width, this.innerElements = [].slice.call(this.selector.children), this.currentSlide = this.config.startIndex, this.transformProperty = this.webkitOrNot(), this.init(), ["resizeHandler", "touchstartHandler", "touchendHandler", "touchmoveHandler", "mousedownHandler", "mouseupHandler", "mouseleaveHandler", "mousemoveHandler"].forEach(function (e) {
      ...
      }return n(e, [{ key: "mergeSettings", value: function (e) {
          ...
          if (null === this.selector) throw new Error("Something wrong with your selector 😭");this.resolveSlidesNumber(), this.selector.style.overflow = "hidden", this.sliderFrame = document.createElement("div"), this.sliderFrame.style.width = this.selectorWidth / this.perPage * this.innerElements.length + "px", this.sliderFrame.style.webkitTransition = "all " + this.config.duration + "ms " + this.config.easing, this.sliderFrame.style.transition = "all " + this.config.duration + "ms " + this.config.easing, this.config.draggable && (this.sliderFrame.style.cursor = "-webkit-grab");for (var e = document.createDocumentFragment(), t = 0; t < this.innerElements.length; t++) {
          ...
          }this.sliderFrame.appendChild(e), this.selector.appendChild(this.sliderFrame), this.slideToCurrent(), this.config.onInit.call(this);
          ...
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1;0 === this.currentSlide && this.config.loop ? this.currentSlide = this.innerElements.length - this.perPage : this.currentSlide = Math.max(this.currentSlide - e, 0), this.slideToCurrent(), this.config.onChange.call(this);
        } }, { key: "next", value: function () {
          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1;this.currentSlide === this.innerElements.length - this.perPage && this.config.loop ? this.currentSlide = 0 : this.currentSlide = Math.min(this.currentSlide + e, this.innerElements.length - this.perPage), this.slideToCurrent(), this.config.onChange.call(this);
          ...
          var e = this.drag.end - this.drag.start,
              t = Math.abs(e),
              i = Math.ceil(t / (this.selectorWidth / this.perPage));e > 0 && t > this.config.threshold ? this.prev(i) : e < 0 && t > this.config.threshold && this.next(i), this.slideToCurrent();
...
$(function () {
    $('#news-form').on('submit', function (event) {
        ...
        //RD Station
        var data_array = [{ name: 'email', value: document.getElementById('txt_email').value }, { name: 'empresa', value: document.getElementById('txt_empresa').value }, { name: 'nome', value: document.getElementById('txt_nome').value }, { name: 'identificador', value: 'revista-itforum' },
