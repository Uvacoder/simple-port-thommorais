...
var _latestVideosModal = __webpack_require__(9);

var _latestVideosModal2 = _interopRequireDefault(_latestVideosModal);
...
var _polyfillIntersectionObserver = __webpack_require__(8);
...
exports.default = latestVideos;

var _utils = __webpack_require__(0);

function latestVideos() {
    // get all the elements who has a related video 
    var thumbs = (0, _utils.all)('[data-video]');
    ...
    thumbs.forEach(function (thumb) {
        return thumb.addEventListener('click', showModal, true);
    });
}
