...
var _fontLoader = __webpack_require__(4);

var _fontLoader2 = _interopRequireDefault(_fontLoader);

var _mostImportantJSOfAll = __webpack_require__(6);

var _mostImportantJSOfAll2 = _interopRequireDefault(_mostImportantJSOfAll);

var _home = __webpack_require__(7);

var _home2 = _interopRequireDefault(_home);

var _cats = __webpack_require__(9);

var _cats2 = _interopRequireDefault(_cats);

var _single = __webpack_require__(10);
...
*/
(0, _utils.windowResize)(function (width) {

  if (width <= 769) {

    // dropdown to post categories
    (0, _dropDowns2.default)('.categories-navigation.drop-down');

    // dropdown to language selector
    (0, _dropDowns2.default)('.language-selector');
  }
});

(0, _mostImportantJSOfAll2.default)();
...
exports.default = function () {
    ...
    */
    ...
    var homeBanner = new _swiper2.default('#slider-home', {
        slidesPerView: 2,
        slidesPerGroup: 2,
        spaceBetween: 15,
        preloadImages: false,
...
exports.default = function () {
     ...
     * @type {Swiper}
    */
    var sliderCat = new _swiper2.default('#slider-cat', {
        slidesPerView: 1,
        spaceBetween: 15,
        navigation: {
            nextEl: '#slider-next',
...
exports.default = function () {
    ...
    */
    ...
    var homeBanner = new _swiper2.default('.post-gallery', {
        loop: true,
        slidesPerView: 'auto',
        centeredSlides: true,
        spaceBetween: 10,
...
var _classie = __webpack_require__(2);
  ...
  */
  var preloadImage = function preloadImage(img) {
    ...
    img.addEventListener('load', function () {
      ...
      _classie2.default.add(img, 'loaded');
      _classie2.default.add(img, 'unblur');
    }, false);
  };
...
exports.default = function (selector) {
    ...
    var triggers = (0, _helpers.all)(selector);

    (0, _helpers.forEach)(triggers, function (trigger) {

        var flag = 0;

        _classie2.default.add(trigger, 'ready');
        ...
        document.addEventListener('touchstart', function (event) {
            ...
            if (!isClickInside && flag) {
                ...
                _classie2.default.remove(trigger, 'active');
                flag = 0;
            } else if (isClickInside) {

                _classie2.default.toggle(trigger, 'active');
                flag = 1;
            }
        });
    });
...
exports.windowResize = exports.lazyLoad = exports.handlePolyfills = exports.getElemOffset = exports.isMobile = exports.ScrollHandler = exports.elementIsVisibleInViewport = undefined;

var _elementIsVisibleInViewport = __webpack_require__(14);

var _elementIsVisibleInViewport2 = _interopRequireDefault(_elementIsVisibleInViewport);

var _ScrollHandler = __webpack_require__(15);

var _ScrollHandler2 = _interopRequireDefault(_ScrollHandler);

var _isMobile = __webpack_require__(16);

var _isMobile2 = _interopRequireDefault(_isMobile);

var _getElemOffset = __webpack_require__(17);

var _getElemOffset2 = _interopRequireDefault(_getElemOffset);

var _handlePolyfills = __webpack_require__(18);

var _handlePolyfills2 = _interopRequireDefault(_handlePolyfills);

var _lazyLoad = __webpack_require__(19);

var _lazyLoad2 = _interopRequireDefault(_lazyLoad);

var _windowResize = __webpack_require__(20);
